...
def CheckEnvs(args):
    ...
    bam_fn_c = file_path_from(args.bam_fn_c, exit_on_not_found=True)
    bam_fn_p1 = file_path_from(args.bam_fn_p1, exit_on_not_found=True)
    #bam_fn_p2 = file_path_from(args.bam_fn_p2, exit_on_not_found=True)
    ...
    sample_name_c = args.sampleName_c
    sample_name_p1 = args.sampleName_p1
    #sample_name_p2 = args.sampleName_p2
...
def main():
    ...
    parser.add_argument('--bam_fn_c', type=str, default=None,
                        help="BAM file input, default: %(default)s")

    parser.add_argument('--bam_fn_p1', type=str, default=None,
                        help="BAM file input, default: %(default)s")

    #parser.add_argument('--bam_fn_p2', type=str, default=None,
    #                    help="BAM file input, default: %(default)s")
    ...
    parser.add_argument('--trio', type=str2bool, default=False,
                        help="create folder for trio")
