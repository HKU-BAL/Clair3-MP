...
channel_strat = (
'reference_base', 'alternative_base', 'mapping_quality', 'base_quality', 'strand_info', 'variant_type', 'insert_base',
'phasing_info' , 'stratification_region')
channel_size = len(channel)
channel_size_strat = len(channel_strat)
flankingBaseNum = 16
no_of_positions = 2 * flankingBaseNum + 1
input_shape = [matrix_depth_dict['hifi'], no_of_positions, channel_size]
input_shape_strat = [matrix_depth_dict['hifi'], no_of_positions, channel_size_strat]
ont_input_shape = [matrix_depth_dict['ont'], no_of_positions, channel_size]
ont_input_shape_strat = [matrix_depth_dict['ont'], no_of_positions, channel_size_strat]
...
ont_input_shape_dual = [matrix_depth_dict['ont'] * 2, no_of_positions, channel_size]
ont_input_shape_dual_strat = [matrix_depth_dict['ont'] * 2, no_of_positions, channel_size_strat]
pb_ilmn_input_shape_dual = [matrix_depth_dict['hifi'] * 2, no_of_positions, channel_size]
pb_ilmn_input_shape_dual_strat = [matrix_depth_dict['hifi'] * 2, no_of_positions, channel_size_strat]
label_shape_trio = label_shape * 3
label_shape_dual = label_shape * 2
label_size_trio = label_size * 3
label_size_dual = label_size * 2
label_shape_cum_trio = list(accumulate(label_shape_trio))
label_shape_cum_dual = list(accumulate(label_shape_dual))
...
p_pb_ilmn_input_shape = [matrix_depth_dict['hifi'], no_of_positions, padding_channel_size]
p_ont_input_shape_trio = [matrix_depth_dict['ont'] * 3, no_of_positions, padding_channel_size]
p_ont_input_shape_dual = [matrix_depth_dict['ont'] * 2, no_of_positions, padding_channel_size]
p_pb_ilmn_input_shape_dual = [matrix_depth_dict['hifi'] * 2, no_of_positions, padding_channel_size]
