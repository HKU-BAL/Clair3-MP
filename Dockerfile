...
RUN wget http://www.bio8.cs.hku.hk/clair3/clair3_models/clair3_models.tar.gz -P /opt/models/clair3_models && \
	...
	wget http://www.bio8.cs.hku.hk/clair3_mp/clair3_mp_models/clair3_mp_models.tar.gz -P /opt/models/clair3_mp_models && \
    tar -zxvf /opt/models/clair3_mp_models/clair3_mp_models.tar.gz -C /opt/models/clair3_mp_models && \
    rm /opt/models/clair3_mp_models/clair3_mp_models.tar.gz && \
    cd /opt/bin && \
